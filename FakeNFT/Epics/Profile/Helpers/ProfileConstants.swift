...
enum ProfileConstants {
    ...
    static let endpoint = "https://d5dn3j2ouj72b0ejucbl.apigw.yandexcloud.net"
    static let accessToken = "f8cdd355-f2ef-4d97-959c-d8fa2795d4c8"
    ...
    static let mockProfileSite = "code.s3.yandex.net/landings-v2-ios-developer/space.PNG"
}
